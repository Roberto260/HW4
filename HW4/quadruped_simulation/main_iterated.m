function [tout, Xout, Uout, Xdout, Udout, Uext, FSMout, p] = main_iterated(Gait)
%% --- parameters ---
% ---- gait ----
...
%% Plot 
%close all
%myplot(tout,Xout,Uout,Xdout,Udout,Uext,p);
%plotGaitDiagram(t,Ud);
%Uout contiene le 4 GRF, nelle loro componenti.
end
